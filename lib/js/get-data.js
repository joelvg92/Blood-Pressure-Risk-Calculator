...
function clearCheckbox(){
    document.getElementById("smoke_yes").checked = false;
    document.getElementById("smoke_no").checked = false;
    document.getElementById("diabetes_yes").checked = false;
    document.getElementById("diabetes_no").checked = false;
    document.getElementById("excercise_yes").checked = false;
    document.getElementById("excercise_no").checked = false;
    document.getElementById("history_yes").checked = false;
    document.getElementById("history_yes").checked = false;
}
...
FHIR.oauth2.ready().then(function(client) {
  ...
  function validate(){
    ...
    else if(dbp<49 || dbp > 90){
     displayErrorMessage('DBP should be between 49 and 90');
      $('#calculate').prop('disabled', true);
    }
    ...
    else if(excercise_yes == true && excercise_no == true){
      displayErrorMessage('Please select only single option for excercise');
      $('#calculate').prop('disabled', true);
    }
    ...
    else if(history_yes == true && history_no == true){
      displayErrorMessage('Please select only single option for family history');
      $('#calculate').prop('disabled', true);
    }
    ...
    else if(diabetes_yes == true && diabetes_no == true){
      displayErrorMessage('Please select only single option for diabetes');
      $('#calculate').prop('disabled', true);
    }
    ...
    else if(smoker_yes == true && smoker_no == true){
      displayErrorMessage('Please select only single option for smoke');
      $('#calculate').prop('disabled', true);
    }
    else{
      displayErrorMessage('');
  ...
  displayStatus('Running risk algorithm.......');
  setTimeout(function(){
    displayStatus('Calculating BMI.......');
  }, 1000);
  setTimeout(function(){
    displayStatus('Calculating risk percentage.......');
  }, 2000);
    var age = $('#age').val();
    var gender = $('#gender2').val();
    var wieght = $('#weight').val();
  ...
  function displayChart(result){
    chart =new Chart(document.getElementById("bar-chart"), {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Predicted high blood pressure risk over the duration of one to nine years'
        }
      }
  });
  }
